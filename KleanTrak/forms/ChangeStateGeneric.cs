...
namespace KleanTrak
{
	public class ChangeStateGeneric : ChangeStateBaseForm
	{
		public ChangeStateGeneric(State stateToAssign)
		{
            StateToAssign = stateToAssign;
            InitializeComponent();
            this.Text = stateToAssign.ActionDescription;
		}
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ChangeStateGeneric));
            ...
            this.Name = "ChangeStateGeneric";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "CLEAN TRACK - Consegna Dispositivo";
            this.Load += new System.EventHandler(this.ChangeStateGeneric_Load);
            this.ResumeLayout(false);
            this.PerformLayout();

		}

		private void ChangeStateGeneric_Load(object sender, System.EventArgs e)
		{
            string tmpTitle = this.Text;
		...
		private void btnSalva_Click(object sender, System.EventArgs e)
		{
            ...
            Model.CmdSetDeviceStatus cmd = new Model.CmdSetDeviceStatus
            { 
                OperationID = (StateToAssign.ID).ToString(), 
                DeviceBarcode = textBoxDispositivo.Text, 
                DeviceSerial = textBoxDispositivo.Text, 
                UserSerial = textBoxOperatore.Text,
                UserBarcode = textBoxOperatore.Text
            };

            string cmdToSend = cmd.SaveObjectToXml();
            ...
            {
                var messagebox = new kleanTrak.forms.KMessageBox("Errore durante il cambio stato del dispositivo!\r\n" + ex.Message, "Clean Track");
            ...
            if (respModel != null)
            {
                ...
                {
                    var messagebox = new kleanTrak.forms.KMessageBox("Errore durante il cambio stato del dispositivo!\r\n" + respModel.ErrorMessage, "Clean Track");
                    messagebox.ShowDialog();
                }
                else
