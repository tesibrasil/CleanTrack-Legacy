...
namespace It.IDnova.Fxw
{
  public class StandAloneIoDefs
  {
    ...
    public abstract class IoSettings
    {
      ...
      {
        if (msg.CommandIdentifier != (byte) 81)
      ...
      internal IoSettings(
        StandAloneIoDefs.IoType flags,
        StandAloneIoDefs.ConfigIoOp operation,
        byte channel)
      {
        this._flags = flags;
    ...
    public class OutputSettings : StandAloneIoDefs.IoSettings
    {
      ...
      public OutputSettings(
        byte channel,
        StandAloneIoDefs.ConfigIoMeasUnit measUnitOn,
        StandAloneIoDefs.ConfigIoMeasUnit measUnitOff,
        ushort timeOn,
        ushort timeOff,
        byte cycles)
