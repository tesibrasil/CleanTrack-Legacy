...
namespace IMS7_PARSER
{
    ...
    public class NetworkAPI
    {
        ...
        /// Unmap network drive
        /// </summary>
        public static void NetUse(string path, string Username, string Password) { zNetUse(path, Username, Password); }
        /// <summary>
        /// Unmap network drive
        /// </summary>
        ...
        private static void zNetUse(string path, string psUsername, string psPassword)
        {
            //create struct data
